...
public class ProyectoSeleccionAccountRegistration extends PageObject {
    ...
    public static final Target DATE_BIRTH_MOUNTH = Target.the("Where do we write the date of birth")
            .located(By.xpath("/html/body/ui-view/main/section/div/div[2]/div/div[2]/div/form/div[1]/div[3]/div[4]/div[2]/div/div[1]/select"));
    public static final Target DATE_BIRTH_DAY = Target.the("Where do we write the date of birth")
            .located(By.xpath("/html/body/ui-view/main/section/div/div[2]/div/div[2]/div/form/div[1]/div[3]/div[4]/div[2]/div/div[2]/select"));
    public static final Target DATE_BIRTH_YEAR = Target.the("Where do we write the date of birth")
    ...
    public static final Target COUNTRY_SELECT = Target.the("Where do we write the country where you life")
    ...
    public static final Target YOUR_COMPUTER_VERSION = Target.the("Where do we write the your windows version")
